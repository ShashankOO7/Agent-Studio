...
public class ProjectConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(
                        new Info()
                                .title("AgentStudio — AI Document Intelligence & RAG backend")
                                .description("REST API for AgentStudio: Multi-format document ingestion, vector embeddings with PostgreSQL pgvector, and hybrid conversational Q&A with OpenAI.")

                                .version("1.0.0")
                                .contact(new Contact()
                                        .name("Developer Technologies")
                                        .email("support@developertechnolgoies.com")
                                        .url("https://developertechnologies.com")
                                )
