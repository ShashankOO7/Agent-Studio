# AgentStudio Backend Analysis & User Document Isolation Architecture

This document breaks down the current state of the AgentStudio backend, explains existing workflows, and details step-by-step changes required to ensure each user can only access and chat with their own documents.
...
```java
// File: src/main/java/com/developer/agentstudio/entity/DocumentMetadata.java
...
```java
// File: src/main/java/com/developer/agentstudio/repository/DocumentMetadataRepo.java
...
```java
// File: src/main/java/com/developer/agentstudio/service/CustomUserDetail.java
...
```java
// File: src/main/java/com/developer/agentstudio/service/DocumentIngestionService.java
...
```java
// File: src/main/java/com/developer/agentstudio/service/RagService.java
