...
const getConversationsKey = (userId: string) => `agentstudio:${userId}:conversations`;
const getMessagesKey = (userId: string, conversationId: string) => `agentstudio:${userId}:messages:${conversationId}`;
...
export const conversationApi = {
  ...
  clearUserData: (userId: string): void => {
    try {
      const prefix = `agentstudio:${userId}:`;
